...
export default async function About() {
  ...
  //   setIntro(res?.data)
  // }
  const desc = "本站是一个基于 Next.js 和 LAF 云开发的网站，主要提供 ToDoList 功能。通过结合 Next.js 的强大功能和 LAF 云开发的便捷性，我们打造了一个简洁高效的任务管理平台。用户可以轻松创建、编辑和完成任务，帮助他们更好地组织生活和工作。<br><br/>感谢开发者倾心打造这个网站，让用户可以通过简单而优雅的界面体验到高效的任务管理。无论是工作任务、学习计划还是日常琐事，本站都能帮助您清晰地记录和管理，让生活更加有序、高效。<br><br/>欢迎您来体验本站带来的便利和愉悦，让我们一起提升效率，享受更美好的生活！"
  return (
